...
contract StringsTest is Test {
  ...
  function testCompare() public {
    ...
    assertEq(
      sign("01234567890123456789012345678901".toSlice().compare("012345678901234567890123456789012".toSlice())), -1
    );
    assertEq(
      sign("0123456789012345678901234567890123".toSlice().compare("1123456789012345678901234567890123".toSlice())), -1
    );
