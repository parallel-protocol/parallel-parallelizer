export type Abi_SavingsNameable = [
  {
    "inputs": [
      {
  ...
  {
    "inputs": [],
    "name": "DEPOSIT_WITH_AUTHORIZATION_TYPEHASH",
    "outputs": [
      {
        "internalType": "bytes32",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "REDEEM_WITH_AUTHORIZATION_TYPEHASH",
    "outputs": [
      {
        "internalType": "bytes32",
        "name": "",
...
export declare const Abi_SavingsNameable: Abi_SavingsNameable;
