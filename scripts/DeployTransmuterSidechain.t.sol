...
import { CommonUtils, ContractType } from "@helpers/CommonUtils.sol";
...
contract DeployTransmuterSidechainTest is Test, CommonUtils {
    ...
    function setUp() public {
        ...
        // TODO update
        uint256 chain = Constants.CHAIN_BASE;
        agToken = IERC20(_chainToContract(chain, ContractType.EURp));
        treasury = ITreasury(_chainToContract(chain, ContractType.TreasuryEURp));
    ...
    function testUnit_CheckOracle() external {
        ...
        assertEq(mint, Constants.BASE_18);
        assertEq(burn, Constants.BASE_18);
        assertEq(ratio, Constants.BASE_18);
        assertEq(minRatio, Constants.BASE_18);
        assertApproxEqRelDecimal(redemption, Constants.BASE_18, Constants.BASE_18 / 100, 18);
    }
